export interface BaseCollaborator {
  ...
  // Equipe do supervisor (TARM/Frota/Médico). Só usado quando role === 'SUPERVISOR'.
  // No cadastro global são IDs de colaboradores globais; dentro de um projeto são
  // collaboratorId de outros colaboradores daquele mesmo projeto. Quando preenchida,
  // a pontuação do supervisor é a média da pontuação desses colaboradores.
  equipeIds?: string[];
}

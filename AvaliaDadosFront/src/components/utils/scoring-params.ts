...
export const DEFAULT_PARAMS: NestedScoringParameters = {
    ...
    colab: {
        pausas: [
            { duration: 8159, points: 8 },   // 02:15:59
            { duration: 8279, points: 6 },   // 02:17:59
            { duration: 8399, points: 4 },   // 02:19:59
            { duration: 8519, points: 2 },   // 02:21:59
            { duration: 8639, points: 0 }    // 02:23:59
        ],
    },
    tarm: {
        removidos: [
